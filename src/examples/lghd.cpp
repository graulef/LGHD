...
int main(int argc, char *argv[])
{
    ...
    const cv::Mat rgb_image = cv::imread("data/20160719_200545.jpg", cv::IMREAD_GRAYSCALE);
    ...
    const cv::Mat ir_image = cv::imread("data/20160719_200542.jpg", cv::IMREAD_GRAYSCALE);
