...
bool fp_equal(float n1, float n2, float maxerror) {
...
void FFT(fftwf_complex *M, triple<size_t> sizes, bool backward) {
...
void normalize_min_max(float *array, size_t size, float new_min, float new_max) {
